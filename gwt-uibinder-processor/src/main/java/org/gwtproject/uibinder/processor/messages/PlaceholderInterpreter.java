...
public abstract class PlaceholderInterpreter implements
  ...
  /**
   * To be called from {@link #interpretElement(XMLElement)}. Creates the next placeholder in the
   * {@link MessageWriter} we're building, and returns the text to stand in its place.
   *
